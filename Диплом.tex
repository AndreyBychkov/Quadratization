...
\include{chapters/Введение}
\include{chapters/Цели_и_задачи}
\include{chapters/Определения_и_понятия_2}
\include{chapters/Полиномиализация}
\include{chapters/Квадратизация}
\include{chapters/Эксперименты}
\include{chapters/Заключение}
